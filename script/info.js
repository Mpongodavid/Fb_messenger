...
module.exports.run = async function({ api, event, args, prefix, admin }) {
		...
		const CREATORLINK = "https://www.facebook.com/profile.php?id=100092277325670";
		const BOTCREATOR = "DAVID MPONGO";
		const BOTNAME = "DAVID BOT";
		const FILESOWNER = "David";
...
⁂ Bot Name: ${BOTNAME}
✧ Bot Admin: David mpongo ✰
♛ Bot Admin Link:https://www.facebook.com/profile.php?id=100092277325670
❂ Bot Prefix: ${prefix}
